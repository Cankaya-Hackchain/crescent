...
import { Badge } from "@crescent/ui/badge";
  ...
  return (
    <>
      ...
      <section className="relative isolate">
        ...
        <div className="lg:pb-30 container py-24 sm:py-32">
          <div className="mx-auto  ">
            <div className="max-w-2xl text-start">
              <Badge variant="outline" className="mb-6">
                New Release 1.0 🎉
              </Badge>
              <h1 className="scroll-m-20 text-5xl font-extrabold tracking-tight text-secondary-foreground sm:text-6xl">
                <span className="block">Crescent</span>
                <span className="block text-primary">A Donation Platform</span>
              </h1>
